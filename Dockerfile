...
# STAGE 0
###################
FROM node:18-bullseye as stage9
...
COPY --from=stage9 /home/node/metabase .
...
ADD https://raw.githubusercontent.com/metabase/metabase/master/bin/docker/run_metabase.sh /app/
